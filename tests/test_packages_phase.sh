...
OSEOF
  ...
  assert_contains "$output_file" "apt-get install -y --no-install-recommends ca-certificates curl git jq apache2-utils python3 python3-venv nodejs ufw fail2ban unattended-upgrades"
